...
| `POST`   | `/api/canvas-extensions/installed/{name}/refresh` | Resolve and atomically update from source                 |
...
- Add a backend-keyed service and query hooks for list, install, enable/disable,
  refresh, uninstall, and authenticated bundle fetch.
